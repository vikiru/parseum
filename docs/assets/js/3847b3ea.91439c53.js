        ...
        1111: (e, t, n) => {
            ...
            const i = { title: '\u26a1 Setup' },
                ...
                c = {
                    ...
                    sidebar: 'docs',
                    previous: { title: '\ud83d\udcdd Prerequisites', permalink: '/parseum/prerequisites' },
                    next: { title: '\ud83d\udd0d Testing', permalink: '/parseum/test' },
                },
                u = {},
                l = [{ value: '\u26a1 Setup Instructions', id: '-setup-instructions', level: 2 }];
            function a(e) {
                    ...
                    children: [
                        ...
                        (0, s.jsx)(t.pre, {
                            children: (0, s.jsx)(t.code, {
                                ...
                                children: 'git clone https://github.com/vikiru/parseum.git\r\ncd parseum\n',
                            }),
                        }),
                        '\n',
                        (0, s.jsxs)(t.ol, {
