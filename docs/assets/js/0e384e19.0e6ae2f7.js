                    ...
                    children: [
                        ...
                        (0, i.jsxs)('p', {
                            ...
                            children: [
                                ...
                                (0, i.jsx)('a', {
                                    href: 'https://parseum.surge.sh/',
                                    children: (0, i.jsx)('img', {
                                        src: 'https://img.shields.io/badge/Web-live%20site-blue',
                                        alt: 'Parseum live site hosted via Surge.sh',
                                    }),
                                }),
                                (0, i.jsx)('a', {
                        ...
                        (0, i.jsxs)(s.p, {
                            children: [
                                (0, i.jsx)(s.strong, { children: 'Parseum' }),
                                ' is a markdown parser and editor built utilizing ',
                                (0, i.jsx)(s.a, { href: 'https://github.com/peggyjs/peggy', children: 'Peggy.js' }),
                                ' which generates a parser from a defined ',
                                (0, i.jsx)(s.strong, { children: 'Parsing Expression Grammar (PEG)' }),
                                ' file. Combining this parser with ',
                                (0, i.jsx)(s.strong, { children: 'React' }),
                                ', ',
                                (0, i.jsx)(s.strong, { children: 'TailwindCSS' }),
                                ', and ',
                                (0, i.jsx)(s.strong, { children: 'DaisyUI' }),
